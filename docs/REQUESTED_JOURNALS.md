...
记录日期：2026-09-11。**54 / 54 本已收录；正式目录合计 68 本。** 以下 54 本均为必须逐项完成的目标；现有条目不重复添加。正式收录仍需官网范围、作者指南与准入依据，分区和 SCI/SCIE、EI 独立核验；未知项明确标注。交叉期刊需写明光学适配方向，不能暗示整刊专注光学。Science China-Materials 规范为 Science China Materials。
