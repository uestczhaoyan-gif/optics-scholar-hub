...
规划日期：2026-09-10；执行状态更新：2026-09-11。规划基线为 19 本期刊、9 届会议；当前正式目录为 24 本期刊、16 届会议，另列 3 项展会/论坛（含母子活动）。
