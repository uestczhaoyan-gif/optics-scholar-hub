...
规划日期：2026-09-10；执行状态更新：2026-09-14。规划基线为 19 本期刊、9 届会议；当前正式目录为 74 本期刊、35 届会议，另列 9 项展会/论坛（含母子活动）。
...
| 会议      | 35 届；普通投稿、PDP、注册及举办信息分开                    | 当届通知、未知日期、国内与 SPIE 等系列扩充、冲突核实                     |
