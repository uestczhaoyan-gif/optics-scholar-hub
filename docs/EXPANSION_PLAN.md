...
规划日期：2026-09-10；执行状态更新：2026-09-13。规划基线为 19 本期刊、9 届会议；当前正式目录为 70 本期刊、20 届会议，另列 7 项展会/论坛（含母子活动）。
...
| 类别      | 已完成                                                      | 剩余工作                                                                 |
| --------- | ----------------------------------------------------------- | ------------------------------------------------------------------------ |
| 期刊      | 70 本，用户指定 54 本全部收录；SCI/EI、分区及方向标签已实现 | 当前数据库证据、JCR/CAS 版本和学科、中文 EI 与薄弱方向候选、交叉适配样例 |
| 会议      | 19 届；普通投稿、PDP、注册及举办信息分开                    | 当届通知、未知日期、国内与 SPIE 等系列扩充、冲突核实                     |
| 展会/论坛 | 7 项，独立导航与母子关系；来源巡检已覆盖                    | 2026-09-12 已纳入离线维护队列；继续补后续届次并处理纳米压印论坛日期冲突  |
