...
规划日期：2026-09-10；执行状态更新：2026-09-13。规划基线为 19 本期刊、9 届会议；当前正式目录为 74 本期刊、21 届会议，另列 7 项展会/论坛（含母子活动）。
