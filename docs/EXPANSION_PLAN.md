...
规划日期：2026-09-10；执行状态更新：2026-09-11。规划基线为 19 本期刊、9 届会议；当前正式目录为 65 本期刊、19 届会议，另列 7 项展会/论坛（含母子活动）。
...
| 类别      | 已完成                                                      | 剩余工作                                                                 |
| --------- | ----------------------------------------------------------- | ------------------------------------------------------------------------ |
| 期刊      | 65 本，用户指定 54 本全部收录；SCI/EI、分区及方向标签已实现 | 当前数据库证据、JCR/CAS 版本和学科、中文 EI 与薄弱方向候选、交叉适配样例 |
